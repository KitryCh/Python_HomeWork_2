...
print(berries)
result_berries = []
result_berries.append(berries[-1] + berries[0] + berries[1])
for i in range(1, len(berries) - 1):
    result_berries.append(berries[i - 1] + berries[i] + berries[i + 1])
result_berries.append(berries[-2] + berries[-1] + berries[0])
max = 0
for i in result_berries:
    if i > max:
        max = i
print(max)